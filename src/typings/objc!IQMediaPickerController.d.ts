...
declare class IQMediaPickerSelection extends NSObject {
	...
	addAssets(assets: NSArray<PHAsset> | PHAsset[]): void;

	addAssetsURL(urls: NSArray<NSURL> | NSURL[]): void;

	addAudios(audios: NSArray<MPMediaItem> | MPMediaItem[]): void;

	addImages(images: NSArray<UIImage> | UIImage[]): void;
}
